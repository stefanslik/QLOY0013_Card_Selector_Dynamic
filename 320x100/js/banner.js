...
$(document).ready(function(){
  preloadimages(["logos.png", "shape-mask.svg", "shape-red.svg", "shape-blue.svg", "shape-red-end-frame.svg", "shape-red-end-frame2.svg"]).done(function (images) {
...
function initCSS() {
    ...
    TweenLite.set($("#white-shape"), {x: -95});
}
...
//    tl.to("#red-shape", .7, {rotation: 0, scaleX: 4, scaleY: 4, opacity: 0, x: 575, y: 75, ease: Sine.easeInOut}, "1.45")
...
//    tl.from("#f2-copy", 1.5, {alpha: 0, ease: Sine.easeOut}, "5.2")
    ...
    //tl.to("#f2-copy", .5, {alpha: 0, ease: Sine.easeOut}, "10")
...
function startAnimation() {
    ...
    tl.to("#mask-shape", .7, {rotation: 0, scaleX: 4.2, scaleY: 4.2, x: -1650, y: -1315, ease: Back.easeIn}, "1.1")
    tl.to("#blue-shape", .7, {rotation: -230, scaleX: 0.6, scaleY: 0.6, x: -49, y: 160, ease: Sine.easeOut}, "1.45")
    ...
    tl.to("#blue-shape", .7, {x: 30, y: 390, ease: Sine.easeIn}, "9")
//    tl.to("#red-shape", .7, {x: 25, y: 375, ease: Sine.easeIn}, "4.5")
    ...
    tl.to("#red-shape-base", 1.3, {scale:2, x: 300, ease: Sine.easeOut}, "9")
    tl.to(".bg-image-01", 2, {alpha: 0, ease: Sine.easeOut}, "10")

    tl.from(".logos", 2, {alpha: 0, ease: Sine.easeOut}, "9.2")

    //FRAME 03
    //tl.to("#white-shape", 2, {autoAlpha:.6, x: 115, y: 700, rotation:-30, ease: Sine.easeInOut}, ".1")

    tl.from("#f3-copy", 1, {alpha: 0, ease: Sine.easeOut}, "9")
